...
- 同步 `deploy-heroku` 分支上的動態環境變數架構回 `main` 分支。
- 於 `docker-compose.yml` 引入 `.env` 變數掛載，讓本地 Docker 環境可完美對接雲端架構而不依賴硬編碼。
- 新增 `example.env` 提供本地部署與變數設定範本。
- 將 `.env` 列入 `.gitignore` 以防止敏感資訊外洩。
...
# #   [ 2 0 2 6 - 0 6 - 2 3 ]   -   �O�_W�ex��U	cjd||v^�v/��� 
 # # #   F i x e d  
 -   b a c k e n d / e n d p o i n t s / c u s t o m e r s . p y :   �O�_  c o u n t - b y - t a g s   �zޞ(W  P o s t g r e S Q L   �SxeS�gb�-NG�0R  L I K E   ' U % '   �l	gck�x�+�  %   W[CQ@b\�v  5 0 0   /�����Nxe��{pu8^0 
 # #   [ 2 0 2 6 - 0 6 - 2 3 ]   -   �O�_W�ex��U�x�[#�P}Bf�v  4 0 5   /��� 
 # # #   F i x e d  
 -   f r o n t e n d / s r c / p a g e s / R i c h M e n u . j s x :   �O�_0�x�[#�P}0Bf/���|T�SNX[(W�v  / r i c h m e n u / d r a f t s   A P I   \�  4 0 5   M e t h o d   N o t   A l l o w e d   �vOUL���s�]�fck�p|T�S  / r i c h m e n u / m e t a d a t a   &N�P^�ck�x<h_�v  P a y l o a d 0 
 