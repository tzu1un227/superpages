...
- **­×¥¿ (backend/endpoints/rule_designer.py)**: ­×¥¿«Ø¥ß¡B§R°£ªk«h®É¡AµLªk¥¿½T¦P¨B Sensor ªk«hªº°ÝÃD (­ì¥»»~¥Î category »P msg_in Äæ¦ì¡A²{¤w­×¥¿¬° type »P content Äæ¦ì)¡C
- **­×¥¿ (frontend/src/components/FlexMessageEditor.jsx)**: ­×¥¿·í«ö¶s¥¼¸j©w¼ÐÅÒ®É²£¥Íªº sys_bind ®æ¦¡·|¾É­P Webhook ¸ÑªRµo¥Í SyntaxError ªº°ÝÃD¡A±NªÅªº¼ÐÅÒ¦r¦ê§ï¬° []¡C

## [2026-07-15] ¹Ï¤å°T®§¹wÄý»P«ö¶sÄ²µo¾÷¨î­×¥¿ (Issue #31)
- **­×¥¿ (frontend/src/components/FlexMessageEditor.jsx)**: ­×¥¿¹Ï¤å°T®§¼ÐÃDµLªk´«¦æ (wrap: true) »P¼ÐÃD/»¡©ú¤å¦r¶¡¶Z¹L¤pªº±Æª©°ÝÃD¡C
- **­×§ï (frontend/src/components/FlexMessageEditor.jsx)**: ²Î¤@©Ò¦³°T®§«ö¶sªº Postback ®æ¦¡¬° sys_bind|...|¹ê»Ú¤å¦r¡AÅý«áºÝ¯à¦³¤@­Pªº¸ÑªR®æ¦¡¡C
- **­×§ï (backend/endpoints/rule_designer.py)**: ¦b«Ø¥ß¡B§ó·s¡B§R°£ÃöÁä¦r¦^ÂÐ (Message) ªk«h®É¡A¦P¨B³B²z¹ïÀ³ªº Sensor ªk«h (Âù­yªk«h¾÷¨î)¡A¥H¸Ñ¨M¹Ï¤å°T®§ÁôÂÃ«ö¶sµLªkÄ²µoÃöÁä¦rªº°ÝÃD¡C
...
- ×¥ CustomerCenter.jsx kTÉ¡A]Ò°}CQ~]Å¦rÓ¾É­PeÝµeY (Âµe) DC
-  CustomerCenter.jsx ¤WC@ onScroll Æ¥AÏ¥ÎªÌºuÊ¨ì©³É¦Û°Ä²oJÑ¾lW (Infinite Scroll)C
- ×¥ liff_questionnaire.py gJÝ¨Ò¦ Private_var ÆªÉ¡A~Ï¥ str() É­PDtÎµLk json.loads TÑªR BugFwï¬°Î¤@Ï¥ json.dumps(..., ensure_ascii=False) ixsC

## [2026-07-07] Customer Center Background Loading Fix
- ×¥GN CustomerCenter.jsx  Infinite Scroll ^**IJ (Chunked Background Fetch)**C]eÝ·jMOwgJbOé¤¤}CApGOÝ­nUuÊ¤~J]Infinite Scroll^A|É­P|JÏ¥ÎªÌ¦bjMÉµLkQC{b|bì¦¸iJÉ¦Û°Ê¤JÒ¦Æªì§¹ATOjM\iHÎ¤C
...
 -   yd0*gOR[b_MbËYÕRå]0eW[0
 -   \Hrb9eºp  f i x e d   [MOºxÝOæ]tPkTBfNg b;NgQ¹[@SJXOPy0 
 
...
 -   ºxÝO!q  G u n i c o r n   _UÕRY\P  W o r k e r T NðS_jhV
