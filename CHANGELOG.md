...
- **後端 (ackend/endpoints/richmenu.py)**: 修正定期刷新預設圖文選單時，使用 ulk_link_all_users 導致覆蓋個人設定的 Bug。
...
 
## [2026-07-06] 圖文選單預設狀態與排程邏輯重構
- 修正: \ackend/endpoints/richmenu.py\ 移除了 \save_rich_menu_metadata\ 與 \set_default_rich_menu\ 儲存時強制將其他預設選單降級為 \published\ 的邏輯。
- 新增: \save_rich_menu_metadata\ 與 \set_default_rich_menu\ 中加入時間重疊防呆檢查，當設定排程預設時若時間與其他預設排程重疊，將回傳 400 錯誤。
- 變更: \check_and_apply_scheduled_rich_menus\ 加入了過期自動降級機制，時間過期的預設選單會自動更新為 \published\。
- 變更: \rontend/src/pages/RichMenu.jsx\ 動態判斷 UI 上哪一張選單應該被標示為「預設」。現在會比對排程時間與目前時間，未到達時間的顯示為「排程待生效」。

## [2026-07-07] Customer Center UI Fixes & LIFF Tag Format
- ץ CustomerCenter.jsx kTɡA]Ұ}CQ~]ŦrӾɭPeݵeY (µe) DC
-  CustomerCenter.jsx ȤWC@ onScroll ƥAϥΪ̺uʨ쩳ɦ۰ĲoJѾlW (Infinite Scroll)C
- ץ liff_questionnaire.py gJݨҦ Private_var ƪɡA~ϥ str() ɭPDtεLk json.loads TѪR BugFwאּΤ@ϥ json.dumps(..., ensure_ascii=False) ixsC

## [2026-07-07] Customer Center Background Loading Fix
- ץGN CustomerCenter.jsx  Infinite Scroll ^**IJ (Chunked Background Fetch)**C]eݷjMOwgJbO餤}CApGOݭnUuʤ~J]Infinite Scroll^A|ɭP|JϥΪ̦bjMɵLkQC{b|b즸iJɦ۰ʤJҦƪ짹ATOjM\iHΤC

 # #   [ 2 0 2 6 - 0 7 - 1 5 ]   Ɩ-N�{t�_�z�BfhV��e�X  c r o n _ t a b l e _ c h e c k e r 
 -   �e�X  b a c k e n d / u t i l s / s c h e d u l e r . p y �Ɩ-N�{t̀of�czhV0
 -   ,d�y  p r o j e c t _ s t a t s _ p r o c e s s o r   �  r i c h _ m e n u _ s c h e d u l e r _ p r o c e s s o r   �_  a p p . p y   �  s c h e d u l e r . p y 0
 -   �e�X  c r o n _ t a b l e _ c h e c k e r   �kR��[BfT@b	gwQ
kP�:OghV|v�  c h e c k _ c r o n _ t a b l e   w e b s o c k e t   �N�N0
 -   �yd�  a p p . p y   -N
�	g�cz��/���|!|;Nz_0 
 
 # #   [ 2 0 2 6 - 0 7 - 1 5 ]   �Ock�}�r�ϑ��T��A I m�[�Rt�b�U I 
 -   �yd�0*g�O���R�[b�_Mb���Y�R�]0�eW[0
 -   \Hrb�9e�p  f i x e d   �[MO��x�O�]tP��k��TBfNg �b;N��gQ�[@SJXOP�y0 
 
 # #   [ 2 0 2 6 - 0 7 - 1 5 ]   �Ock  c r o n _ t a b l e _ c h e c k e r   ͑�|v�OUL�
 -   �Ock(WwQ	gYP  O A   qQ(u�vT  s o c k e t _ u r l   :OghV�v�`�lN�g͑�|v�  W e b S o c k e t   �N�N�vOUL��9e�N  s e t ( )    }�&N\�kPhs�z:OghV�P|v� N!k0 
 
 # #   [ 2 0 2 6 - 0 7 - 1 5 ]   �Ock  G u n i c o r n   Y  W o r k e r   ͑��WL�  S c h e d u l e r   OUL�
 -   �N�  U D P   S o c k e t   �}�[,g0W  P o r t   ( 4 7 2 0 0 )   �[\O�L�z��  ( C r o s s - p r o c e s s   L o c k ) 0
 -   �x�O!q֊  G u n i c o r n   _U�RY\P  W o r k e r �T N�S_jhV
N�S	g NP  W o r k e r   g�WL�̀of�cz��MQ�wBf��gQ͑�|v�Q  t i m e r   ˊBl0 
 