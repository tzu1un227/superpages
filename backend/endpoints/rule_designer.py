...
DEFAULT_FOLLOW_FUNCTION = 'pri_set("name",sys.name(m)),pri_set("pic",sys.picture(m)),update(f"switch_rm|{dboperation.dbModel.getTable(\'rich_menu_metadata:\' + str(dboperation.dbModel.appname), filter=[(\'status\',\'default\')])[0][\'ui_uuid\']}")'
